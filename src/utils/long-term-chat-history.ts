...
import { getYassirDir } from './paths.js';
 ...
 * Stores messages in .yassir/messages/chat_history.json
 */
export class LongTermChatHistory {
  ...
  constructor(baseDir: string = process.cwd()) {
    this.filePath = join(baseDir, getYassirDir(), MESSAGES_DIR, MESSAGES_FILE);
  }
