...
import { getKabutoDir } from './paths.js';
 ...
 * Stores messages in .kabuto/messages/chat_history.json
 */
export class LongTermChatHistory {
  ...
  constructor(baseDir: string = process.cwd()) {
    this.filePath = join(baseDir, getKabutoDir(), MESSAGES_DIR, MESSAGES_FILE);
  }
