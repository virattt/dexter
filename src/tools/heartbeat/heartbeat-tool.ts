...
const HEARTBEAT_MD_PATH = kabutoPath('HEARTBEAT.md');
const HEARTBEAT_JOB_NAME = 'Heartbeat';

export const HEARTBEAT_TOOL_DESCRIPTION = `
Manage your periodic heartbeat checklist (.kabuto/HEARTBEAT.md).
...
export const heartbeatTool = new DynamicStructuredTool({
  name: 'heartbeat',
  description:
    'View or update the heartbeat checklist (.kabuto/HEARTBEAT.md) that controls periodic monitoring.',
