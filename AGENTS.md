...
- Supported: OpenAI (default), Anthropic, Google, xAI (Grok), OpenRouter, OrcaRouter, Ollama (local).
...
- LLM keys: `OPENAI_API_KEY`, `ANTHROPIC_API_KEY`, `GOOGLE_API_KEY`, `XAI_API_KEY`, `OPENROUTER_API_KEY`, `ORCAROUTER_API_KEY`
